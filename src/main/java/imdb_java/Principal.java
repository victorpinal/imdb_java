...
public class Principal {
    ...
    private void CargarRutasMRU() {
        ...
        // Si no existe ya pedimos el directorio desde el que se cargar� el listado de pel�culas
    ...
    /**
     * Actualiza el grid, mostrando los ficheros seg�n las opciones seleccionadas
     * @param bRecarga
     */
    ...
    /**
     * Devuelve una lista de ficheros filtrados por extensi�n de los directorios indicados
    ...
    private void CargarTabla(boolean bVerTodo) {
        ...
        //A�ade los registros (ficheros) que no existen en la base de datos
        if (bVerTodo) {
            sql += " WHERE 1=1";
        } else {
